		...
		<div class="container-fluid" style="padding-top: 50px;">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <form class="form-group" name="registration" method="post" action="StudentRegistration" onsubmit="return view()">
                        <div class="row ">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>*MAIL ID:</label> 
                                <input class="form-control" type="tel" name="emid" id="emid"  placeholder="Email Id">
                            </div>
                            <div class="col-md-6">
                                <label>*Branch</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="yop" id="yop" placeholder="Year of Pass">
                            </div>
                            <div class="col-md-6">
                                <label>*Percentage</label> 
                                <input class="form-control" type="text" name="percentage" id="percentage"  placeholder="*Percentage">
                            </div>
                        ...
                        <div class="row padding-bottom">
                            ...
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-center btn-success ">SUBMIT</button>
                                <p id="p3"> </p>
                            </div>
